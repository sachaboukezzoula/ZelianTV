      ...
      <div className="px-4 sm:px-6 py-4 flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[#555] text-xs mb-2">
            {[year, runtime, type === 'movie' ? 'Film' : 'Série'].filter(Boolean).join(' · ')}
          </p>
          ...
          <div className="flex gap-5 mb-3">
            <div>
              <p className="text-[#444] text-[9px] uppercase tracking-wide mb-0.5">Note critique</p>
              <p className="text-[#f97316] text-sm">★ {media.vote_average.toFixed(1)}</p>
            </div>
            <div>
              <p className="text-[#444] text-[9px] uppercase tracking-wide mb-0.5">Note public</p>
              <p className="text-gray-300 text-sm">{media.vote_average.toFixed(1)} / 10</p>
            </div>
          </div>

          <WatchlistButton tmdbId={tmdbId} mediaType={type} />
        </div>
      </div>
